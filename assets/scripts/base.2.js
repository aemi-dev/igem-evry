	...
	static render() {
		...
		childPromises.push(
			Header.heading( {
				...
				medal: fragment.querySelector( 'img#tmp-site-medal' ),
...
class Page {
	...
	static async header( text, options = Object.create( null ) ) {
		const {
			...
			compareFirstWebP = 'https://2020.igem.org/wiki/images/1/15/T--Evry_Paris-Saclay--Banner-Alive_Rosewood.webp.jpg',
			...
			compareSecondWebP = 'https://2020.igem.org/wiki/images/0/09/T--Evry_Paris-Saclay--Banner-Dead_Rosewood.webp.jpg',
